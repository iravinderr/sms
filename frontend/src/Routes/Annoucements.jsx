        ...
        <div className='w-4/5 h-screen overflow-x-hidden overflow-y-hidden'>
            ...
            {/* NavBar */}
              <div className='bg-white w-screen flex items-center justify-between h-20 p-4 m-4 rounded-2xl'>
                <h1 className=' flex text-4xl font-semibold '>Annoucement  <MdAnnouncement className='ml-4'/>
                </h1>

                <button className='pr-4 btn-style ' onClick={()=>{
                  setShowModal(true);
                }}>
                <IoMdCreate />Create new</button>
                </div>
            </div>
            ...
            <div className="flex h-screen m-4 rounded-2xl gap-4">
              <div className="card-style">
                ...
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                 Et quos doloremque ducimus esse deserunt, odio inventore?
                  Voluptatem et itaque odio laboriosam quas illo ipsa. 
                  Quasi culpa adipisci ipsum dignissimos facilis odio 
                  veniam illo quae deserunt quam. Voluptate labore quo 
                  debitis amet ex officiis ipsa itaque, saepe eum ratione veniam consequatur.
                </p>
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                  ...
                  <h3 className="text-2xl font-semibold flex">
                    New Annoucement!!<GrAnnounce className='ml-4' />
                  </h3>
                ...
                <div className="relative p-6 flex-auto">
                  ...
                  <form >
                    <textarea className="my-4 text-blueGray-500 text-lg leading-relaxed text-area border-2 
                    " 
                    rows={4} cols={65}
